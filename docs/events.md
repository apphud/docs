...
Чтобы настроить Subscriptions Notifications воспользуйтесь [этим руководством](creating-app.md#subscription-status-url). Мы **настоятельно рекомендуем** их настроить, чтобы получать более точные данные о состоянии подписок.
...
> Более подробно об Apple Subscriptions Notifications вы можете прочитать в <a href="https://blog.apphud.com/ru/subscriptions-notifications-2/" target="_blank">нашем блоге</a>.
